...
class Trainer:
    ...
    Args:
        model (contrastlib.BaseModel): ML model.
        config (dict): Dictionary of hyper-parameters.
    """

    def __init__(self, model: contrastlib.BaseModel, config: dict):
        ...
        self.train_loader_pos: dataloader.DataLoader
        self.train_loader_neg: dataloader.DataLoader
        self.test_loader_pos: dataloader.DataLoader
        self.test_loader_neg: dataloader.DataLoader
    ...
    def train(self) -> None:
        ...
        for (data_pos, _), (data_neg, _) in zip(self.train_loader_pos, self.train_loader_neg):
            ...
            loss_dict = self.model.loss_func(data_pos, data_neg)
